...
double crystalCG::GradientCoherentNoise3D (double x, double y, double z, int seed,
  int q)
{
...
double crystalCG::GradientNoise3D (double fx, double fy, double fz, int ix,
...
int    crystalCG::IntValueNoise3D (int x, int y, int z, int seed)
{
...
double crystalCG::ValueCoherentNoise3D (double x, double y, double z, int seed,
  int q)
{
  // Create a unit-length cube aligned along an integer boundary.  This cube
  // surrounds the input point.
...
double crystalCG::ValueNoise3D (int x, int y, int z, int seed)
{
